...
class CircleImage : AppCompatImageView {
    ...
    constructor(
        ...
        val a =
            context.obtainStyledAttributes(attrs, R.styleable.CircleImage, defStyle, 0)
        mBorderWidth = a.getDimensionPixelSize(
            R.styleable.CircleImage_civ_border_width,
            DEFAULT_BORDER_WIDTH
        )
        mBorderColor = a.getColor(
            R.styleable.CircleImage_civ_border_color,
            ContextCompat.getColor(context, R.color.colorPrimary)
        )
        mBorderOverlay = a.getBoolean(
            R.styleable.CircleImage_civ_border_overlay,
            DEFAULT_BORDER_OVERLAY
        )
        mCircleBackgroundColor = a.getColor(
            R.styleable.CircleImage_civ_circle_background_color,
